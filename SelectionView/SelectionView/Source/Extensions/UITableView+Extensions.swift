...
public extension UITableView {
    ...
    func register<T: UITableViewCell>(reusableCell _: T.Type) where T: ReusableView, T: NibLoadableView {
    ...
    func dequeReusableCell<T: UITableViewCell>(forIndexPath indexPath: IndexPath) -> T where T: ReusableView, T: NibLoadableView {
